...
<!-- Why is there a deficit from active control for low WMC participants? -->
...
Moreover, the present findings have implications for the value of active control in relational learning more generally.
...
For those individuals, active learning may be most effective in concert with memory aids that support comparison and integration [@eglington2018retrieval; @son2011connecting].
